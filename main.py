...
set_seed(32)
TOKEN = "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"
...
def main(model_name, model_type, task_vector_saving_path = None, task_vector_exist = False, if_original_model = False):
    ...
    elif model_type == 'PKU-Alignment/alpaca-7b-reproduced':
        tokenizer = AutoTokenizer.from_pretrained(
            model_type, token=access_token, trust_remote_code=True, use_fast=True
        )
        tokenizer.pad_token = "[PAD]"
        model_path = alpaca_7b_model_path
...
#     model_type = "meta-llama/Llama-2-7b-hf"
    model_type = "PKU-Alignment/alpaca-7b-reproduced"
