...
def my_function(prompt):
    ...
    alpaca_output = alpaca_output.split('ASSISTANT:')[1].strip()
...
df_violation_test.to_csv('results/inference-8B_violations_test_baseline.csv')
...
df_test_save.to_csv('results/inference-8B_safe_test_baseline.csv')