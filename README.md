...
## Dataset
We use the safe.csv as the normal data. 
And we use Privacy Violation_train.csv from [PKU-SafeRLHF](https://huggingface.co/datasets/PKU-Alignment/PKU-SafeRLHF) as  the harmful data.
